        ...
        self.img = ImageTk.PhotoImage(file="bg1.png")
        ...
        label1 = Label(frame_input, text="Welcome to Oddish, please log in.", font=('impact', 32, 'bold'), fg="black",
                       bg="white")
...
def appscreen(self):
    ...
    label1 = Label(Frame_login, text="Hi! Welcome To Seek coding", font=('times new roman', 32, 'bold'), fg="black",
                   bg='white')
    label1.place(x=375, y=100)

    label2 = Label(Frame_login, text="Youtube Channel.If you are New to Channel", font=('times new roman', 32, 'bold'),
                   fg="black", bg='white')
    label2.place(x=235, y=160)

    label3 = Label(Frame_login, text="Please Subscribe,Like And Share", font=('times new roman', 32, 'bold'),
                   fg="black", bg='white')
    label3.place(x=340, y=220)

    btn2 = Button(Frame_login, text="Logout", command=self.loginform, cursor="hand2", font=("times new roman", 15),
                  fg="white", bg="orangered", bd=0, width=15, height=1)
